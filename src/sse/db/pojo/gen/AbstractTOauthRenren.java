...
/**
 * AbstractTOauthRenren entity provides the base persistence definition of the
 * TOauthRenren entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTOauthRenren implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTOauthRenren() {
	}

	/** minimal constructor */
	public AbstractTOauthRenren(String token, TAccount TAccount) {
		this.token = token;
