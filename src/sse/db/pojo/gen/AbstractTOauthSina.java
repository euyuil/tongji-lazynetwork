...
/**
 * AbstractTOauthSina entity provides the base persistence definition of the
 * TOauthSina entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTOauthSina implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTOauthSina() {
	}

	/** minimal constructor */
	public AbstractTOauthSina(String token, TAccount TAccount,
			String tokenSecret) {
		this.token = token;
